...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Dr Sammy Online",
    "site_header": "Dr Sammy Online",
    # "site_logo": "img/site/bestPay Logo.png",
    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Dr Sammy Online",
    "copyright": "Dr Sammy Online",
    # "login_logo": "img/site/bp.png",
    "welcome_sign": "Welcome to the Dr Sammy Online Admin",
